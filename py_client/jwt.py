# code reference- https://www.codingforentrepreneurs.com/blog/python-jwt-client-django-rest-framework-simplejwt/

# A dataclass in python is a specially structured class that is optimized for the storage and representation of data.
# Dataclasses have certain in-built functions to look after the representation of data as well as its storage.
...
class JWTClient:
    ...
    """
    # In dataclass, the data types for the variables are written in front of them.
    access:str = None
    refresh:str = None
